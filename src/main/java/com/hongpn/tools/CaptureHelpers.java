...
public class CaptureHelpers extends ScreenRecorder {
    ...
    public static void CaptureScreenshot(WebDriver driver, String screenName) {
        ...
        try {
            ...
            File theDir = new File(PropertiesHelpers.projectPath + PropertiesHelpers.getPropValue("exportCapturePath"));
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(PropertiesHelpers.projectPath + PropertiesHelpers.getPropValue("exportCapturePath") + "/" + screenName + "_" + dateFormat.format(new Date()) + ".png"));
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        File file = new File(PropertiesHelpers.projectPath+PropertiesHelpers.getPropValue("exportVideoPath")+"/"+methodName+"/");
